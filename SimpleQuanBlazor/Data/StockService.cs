...
namespace SimpleQuanBlazor.Data
{
    public class StockService
    {
        ...
        public async Task<List<StockInfo>> GetTop100ByTurnoverAsync()
        {
            ...
            // 东方财富实时数据接口 (不支持历史查询)
            string url = "https://push2.eastmoney.com/api/qt/clist/get?pn=1&pz=100&po=1&np=1&ut=bd1d9ddb04089700cf9c27f6f7426281&fltt=2&invt=2&fid=f6&fs=m:0+t:6,m:0+t:80,m:1+t:2,m:1+t:23,m:0+t:81+s:2048&fields=f12,f14,f2,f3,f6,f5,f62";
